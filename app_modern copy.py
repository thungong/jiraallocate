...
<style>
    .stApp {
        background: linear-gradient(135deg, #0EA5E9 0%, #3B82F6 25%, #6366F1 75%, #8B5CF6 100%);
        min-height: 100vh;
    }
    ...
    .stButton > button:hover {
        ...
        /* Data Editor Styling - Ultra Light Background */
        ...
        /* Data Editor Headers - Clean White */
        ...
        /* Data Editor Control Buttons - High Contrast */
        ...
        /* Force visibility of add/delete controls */
        ...
        /* Remove any gradient or background image overrides */
        div[data-testid="stDataFrame"],
        div[data-testid="stDataFrame"] * {
